...
int insereHash_semTratarDivisao(Hash* h, int elem){
    if(h == NULL) return 0;
...
int insereHash_semTratarMultiplicacao(Hash* h, int elem){
    if(h == NULL) return 0;
...
int insereHash_semTratarDobra(Hash* h, int elem) {
    if(h == NULL) return 0;
...
int buscaHash_semTratarDivisao(Hash* h, int elem, int *p){
    if(h == NULL) return 0;
    int pos = chaveDivisao(elem, h->tam);
...
int buscaHash_semTratarMultiplicacao(Hash* h, int elem, int *p){
    if(h == NULL) return 0;
    int pos = chaveMultiplicacao(elem, h->tam);
    if(h->tabela[pos] == NULL) return 0;
    if(*(h->tabela[pos]) == elem){
...
int buscaHash_semTratarDobra(Hash* h, int elem, int *p){
    if(h == NULL) return 0;
    int pos = chaveDobra(elem, h->tam);
    if(h->tabela[pos] == NULL) return 0;
    if(*(h->tabela[pos]) == elem){
