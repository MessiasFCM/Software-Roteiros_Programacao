...
int insereHash_EnderAbertoDivisao(Hash* h, int elem){
  if(h == NULL) return 0;
  int i, pos, newPos;
...
int insereHash_EnderAbertoMultiplicacao(Hash* h, int elem){
  if(h == NULL) return 0;
  int i, pos, newPos;
...
int insereHash_EnderAbertoDobra(Hash* h, int elem){
  if(h == NULL) return 0;
  int i, pos, newPos;
...
int buscaHash_EnderAbertoDivisao(Hash* h, int elem, int *p){
    if(h == NULL) return 0;
    int i, pos, newPos;
    pos = chaveDivisao(elem, h->tam);
    for(i=0; i<h->tam; i++){
...
int buscaHash_EnderAbertoMultiplicacao(Hash* h, int elem, int *p){
    if(h == NULL) return 0;
    int i, pos, newPos;
    pos = chaveMultiplicacao(elem, h->tam);
    for(i=0; i<h->tam; i++){
...
int buscaHash_EnderAbertoDobra(Hash* h, int elem, int *p){
    if(h == NULL) return 0;
    int i, pos, newPos;
    pos = chaveDobra(elem, h->tam);
    for(i=0; i<h->tam; i++){
